<template>
      <v-card class="ma-4" height="590" width="272">
          ...
          <div class="book_contain">
            <v-card-text
              ><div>
                This book is about a kid that did something and i am just
                talking to talk weeeeeeeeee dang i need even more text to test
                this component
              </div>
            </v-card-text>
          </div>
